...
# from https://raw.githubusercontent.com/TiePie/python-libtiepie/master/examples/printinfo.py
...
def print_oscilloscope_info(scp):
    ...
    try:
        print('  Clock output frequecies   : ' + ', '.join(map(tr, scp.clock_output_frequencies)))
